...
- Human-controlled fields are controlled by the teacher/business request, not by AI: knowledge point, difficulty, question type, content mode, algorithm, and image requirement.
